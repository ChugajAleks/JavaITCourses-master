...
//Мы заводим на чтение и на запись по отдельному новому потоку и соединяем их блокирующей 
//ограниченной очередью для передачи данных от читателя к писателю
